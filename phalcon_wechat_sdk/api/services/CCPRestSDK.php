...
class CCPRestSDK {
     ...
     */
    public static function CCCallBack($from,$to,$customerSerNum='',$fromSerNum='',$promptTone='',$alwaysPlay='',$terminalDtmf='',
                              $userData='',$maxCallTime='',$hangupCdrUrl='',$needBothCdr='',$needRecord='',$countDownTime='',
                              $countDownPrompt='') {

        //子帐号
        //todo 设置配置化
        $subAccountSid = 'fd3dd91b7a9e11e6997a6c92bf2c165d';

        //子帐号Token
        $subAccountToken = '7747e4d54003d3b2f285612cb4f755fc';

        //VoIP帐号
        $voIPAccount = '8016313100000002';

        //VoIP密码
        $voIPPassword = 'IT6Jby4x';

        //应用Id
        $appId = '8a216da8570874940157212fe8d00d37';
